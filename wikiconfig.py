...
class Config(multiconfig.DefaultConfig):
    ...
    sitename = u'NetHack 中文维基'

    # Wiki logo. You can use an image, text or both. [Unicode]
    # For no logo or text, use '' - the default is to show the sitename.
    # See also url_prefix setting below!
    logo_string = u'<img src="%s/common/nhcnwiki-logo-128x128.png" alt="NhcnWiki Logo">' % url_prefix_static
    ...
    acl_rights_before = u"IceGuye:read,write,delete,revert,admin"
    ...
    textchas = {
        ...
        #},
        'zh':{
            u"姑射冰尘的第二个字如何发音？请输入汉语拼音.": ur"ye",
            u"姑射冰尘在其第一个视频中使用何种角色？": ur"骑士",
            u"NetHack的玩家实际上是天启骑士中的谁？（答案为四个简体汉字“某某骑士）": ur"战争骑士",
            u"哪个商店在矿坑小镇中一定出现，且老板是一个现实中的教授？（答案为三个汉字或两个汉字均可）": ur"(灯具店|灯店)",
            u"NetHack发行于哪一年？（答案为4个阿拉伯数字）": ur"1987",
            u"百度NetHack贴吧的吧主叫什么？（答案全为小写英文字母）": ur"arurua",
            u"在IOS上架的NetHack中文版把NetHack翻译为什么？（答案为四个简体字）": ur"迷宫亥客",
        },
